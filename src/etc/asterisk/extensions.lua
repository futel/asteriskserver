...
extensions_robotron = require("extensions_robotron")
extensions_toorcamp = require("extensions_toorcamp")
...
for k,v in pairs(extensions_toorcamp) do extensions[k] = v end
