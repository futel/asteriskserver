...
ssh -o StrictHostKeyChecking=no -t -i conf/id_rsa futel@$do_ip "sudo cp /vagrant/conf/sip_local.conf.$conf_version /vagrant/conf/sip_local.conf"
ssh -o StrictHostKeyChecking=no -t -i conf/id_rsa futel@$do_ip "sudo cp /vagrant/conf/sip_callcentric.conf.$conf_version /vagrant/conf/sip_callcentric.conf"
