...
/bin/cp -f /tmp/vagrant/src/sshd_config /etc/ssh/sshd_config
service sshd restart

# XXX we will want more iptables
# XXX will need more ports for iax2 later - asterisk to asterisk
#/etc/init.d/iptables stop
#/tmp/vagrant/src/iptables.sh
...
#cp /tmp/vagrant/src/backup_id_rsa.pub /home/backup/.ssh/authorized_keys
