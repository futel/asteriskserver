...
function challenge_two(mailbox)
    -- XXX dummy
    say("access-granted")
    return goto_main()
end
...
function menu_challenge_two(context, extension)
    do_challenge("achievement-mailbox", "achievement-two", challenge_two)
end
...
extensions_challenge = {
    ...
    challenge_two = context(menu_challenge_two, "challenge_main", {});
}
